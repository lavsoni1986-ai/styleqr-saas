...
const MenuContent = nextDynamic(() => import("@/components/dashboard/MenuContent"), {
  loading: () => (
...
export default async function MenuPage() {
  ...
  return <MenuContent initialCategories={restaurant.categories || []} restaurantId={restaurant.id} />;
}
